...
The detection efficiencies of the forward modules can also be determined with the same elastic scattering sample events, which are about \SI{99.9967}{\percent} and \SI{99.7088}{\percent} respectively.
