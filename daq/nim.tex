...
using a probing rod when no accelerator beam is circulating inside COSY.
...
\end{enumerate*}
The \texttt{event\textunderscore distributor} will forward the data stream to various consumption hosts for usages like online monitoring and online analysis.
...
Tests were carried out using the proton beam at COSY with momentum
...
The accuracy of the combined fit deterioates at small recoil angles, when the elastic peak approaches the MIP peak and both peaks are embeded among the large
