...
extracted width of the elastic peak from the beam data ($\sim$\SI{330}{\keV} at \SI{5}{\MeV}).
Thus, the energy resolution in the experiment is mainly dominated by the finite
...
Two bands of events, which connect to the elastic peak, are observed in the raw TOF-E spectrum of each strip, as shown in the inset of Fig. \ref{fig:tof-e}.
...
only deposit part of their energy in the sensor.
\begin{figure}[b!]
  \centering
  ...
  \label{fig:tof-e}
\end{figure}
The events of the elastic peak and band A are selected roughly and filled into an
...
at $X = \SI{3}{\cm}$ are shown in Fig. \ref{fig:cut}.
...
An extended unbinned Maximum-Likelihood fit with a sum of the Coulomb elastic scattering formula and the Crystal-Ball
...
Thus, the lower range of the $|t|$ measurement can be extended below the limit of set by the TOF-E selection method.
