...
reach an absolute precision of \linebreak $\Delta L/L < \SI{5}{\percent}$ \cite{lmd_tdr}.
Before the intallation at HESR, the KOALA experiment has been commissioned with
...
particle over a sufficently wide range of scattering angles.
