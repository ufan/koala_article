...
\begin{figure}[ht!]
  ...
  \caption{Energy spectra of \(\alpha\) sources for two channels at small (blue)
    and large (black) recoil angles. The main peak from $^{239}Pu$ at
...
\begin{figure}[hb!]
  ...
  \caption{The recoil energy spectrum on a channel of the Ge2 sensor before (black) and after (red) the clustering.}
...
\SI{184}{\meter}.
Storage time for a beam cycle is about \SI{300}{\second}, as shown in Fig. \ref{fig:beam}.
...
\begin{enumerate*}[label=(\roman*)]
\item band A from the interaction of the beam particle with the residual gas
...
Preliminary analysis shows that the lower |t| range can be extended beyond the design
