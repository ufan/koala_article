...
The results are shown as the red curves in Fig. \ref{fig:fwd_performance}.
...
The timing resolution (FWHM) of the forward detector is about \SI{400}{ps}, which is obtained by the dispersion of the timing difference of the two module as show in Fig. \ref{fig:fwd_performance} (c).
\begin{figure}[htb!]
  \centering
...
Due to the high efficiency of both modules, the coincidence between them are required to select a
