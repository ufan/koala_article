...
\begin{figure}[h!]
  ...
  \label{fig:tof-e}
\end{figure}
Three features are recognized in plot: 1) the wide elastic peak around \SI{0.9}{MeV};
...
elastic peak. 
These features are found in all channels covered by the forward detector.
...
The upper band fullfills the TOF-E relation of the recoil proton and it comes
