...
\begin{table}[htb!]
  \centering
  \caption{Characteristics of the two energy spectra in Fig. \ref{fig:clustering}}
  \label{tab:clustering}
  \begin{tabular}{cccccc}
    \hline
    & Peak Energy (MeV) & Peak to Valley & Yield under Peak \\
    \hline
    Before Clustering & 34.6 & 33  & 110.00 \\
    After Clustering  & 34.7 & 234 & 105.00 \\
    \hline
  \end{tabular}
\end{table}
