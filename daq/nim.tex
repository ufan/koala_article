...
and covers a range of recoil angle $\alpha$ ($=\SI{90}{\degree}-\theta$) from \SIrange[range-units=repeat]{-1.5}{15}{\degree}.
...
This corresponds to an angular acceptance of the scattering angle from \SIrange{0.37}{1.49}{\degree}.
...
\begin{figure}[htb!]
  \centering
  \includegraphics[width=0.42\textwidth]{./linearity_only_quadratic.png}
...
\begin{enumerate*}[label=(\roman*)]
\item band A from the the interaction of the beam particle with the residual gas in the beam pipe;
