...
* Introduction
  ...
  Recent experiments like ANKE, EDDA have filled the gap in the proton-proton elastic scattering database above 1 GeV.
  However, these experiments have limited coverage range of the scattering angle and only reaches the region where the nuclear interaction dominates, i.e. 4-momentum transfer squared $|t| \gtrsim 0.02 $.
  There still lacks systematic data with smaller $|t|$, in which the Coulomb-Nuclear Interference (CNI) and the Coulomb interaction dominates.
  
  The KOALA experiment is designed to measure the differential cross-section of (anti)proton-proton elastic scattering over a large 4-momentum transfer range $0.0005 < |t| < 0.1 (GeV/c)^2$. 
