...
** TODO Pure (anti)p-p cross section data measurement, current status
    ...
    - current data available and limitation
...
** Measurement methods
    ...
    - Different strategy of measurements: forward VS recoil
      - Forward strategy limitation:
        ...
        * Complex hardware setup like Roman-pot
      - Advantage of recoil strategy:
        * simpler hardware setup and lower background
...
** KOALA's contribution 
     - KOALA's highlight: using recoil proton to extend coverage and precision at small scattering angle.
     - Meaurement principle and Designed goals: energy range and precision
...
* Software framework
  ToDoList:
  - Aims: to be integrated with PANDA experiment in mind.
