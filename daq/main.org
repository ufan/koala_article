...
* Experiment setup at COSY and the cluster target
  The full setup of KOALA at COSY consists of three arms as shown in Fig. [[fig:koala_setup]]: the hydrogen cluster target, the recoil arm and the forward arm.
  All arms connect to the target chamber in the center and all components share the same vacuum space during experiment.
