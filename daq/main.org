...
* Introduction
  ...
  KOALA was first proposed to measure the antiproton-proton elastic scattering at HESR in the beam momentum range from $1.5 GeV$ to $15 GeV$.
  ...
  The recoil measurement technique is used measuring both the recoil angle and the kinematic energy of the recoil proton
